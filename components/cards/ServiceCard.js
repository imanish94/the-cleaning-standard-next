...
const ServiceCard = ({
  ...
  return (
    <div className="rounded-md bg-SecondaryColor-0 p-6 flex flex-col sm:flex-row items-center gap-6 group relative z-10 before:absolute before:top-0 before:right-0 before:-z-10 before:w-0 before:h-full before:bg-PrimaryColor-0 before:transition-all before:duration-500 before:rounded-md hover:before:w-full hover:before:left-0 pr-7 mb-7 sm:mr-8 md:mr-0">
      <div className="w-[85px] h-[85px] rounded-full bg-white relative flex justify-center items-center z-10">
        <Image 
          src={serviceIcon}
          alt={serviceTitle}
          width={40}
